package com.mycompany.myappserver.utils.logger;

import com.mycompany.myappserver.utils.properties.PropertiesFile;
...
public class Log {
	...
	static {
		try {
			...
			PropertyConfigurator.configure(PropertiesFile.getProperties("edu.co.udistrital.krehab.core.util.logger.Log","log4j.properties"));
